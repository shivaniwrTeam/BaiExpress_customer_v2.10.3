...
class OrderProvider extends ChangeNotifier {
  ...
  changeHasMoreData(bool hasMore) {
    hasMoreData = hasMore;
    notifyListeners();
  }

  changeIsGettingData(bool isGetting) {
    isGettingdata = isGetting;
    notifyListeners();
  }
  ...
  Future<void> getOrder(
    ...
    try {
      if (hasMoreData) {
        changeHasMoreData(false);
        changeIsGettingData(true);
