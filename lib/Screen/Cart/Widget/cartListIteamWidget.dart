              ...
              child: IntrinsicHeight(
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        child: Row(
                          children: [
                            SvgPicture.asset(
                                DesignConfiguration.setSvgPath('remove'),
                    ...
                    if (context.read<UserProvider>().userId != '' &&
                        context.read<CartProvider>().cartList.length > 1)
                      const VerticalDivider(),
                    if (context.read<UserProvider>().userId != '' &&
                        context.read<CartProvider>().cartList.length > 1)
                      Padding(
                        ...
                        child: InkWell(
                            child: Row(
                              children: [
                                SvgPicture.asset(
                                    DesignConfiguration.setSvgPath('buy_now'),
                                    colorFilter: ColorFilter.mode(
                                        Theme.of(context).colorScheme.black,
                                        BlendMode.srcIn)),
                                Text(
                                  " ${getTranslated(context, 'BUY_NOW')}",
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleSmall!
                                      .copyWith(
                            ...
                            onTap: () async {
                              ...
                              if (!context.read<CartProvider>().saveLater &&
                                ...
                                if (context.read<UserProvider>().userId != '') {
                                  // context.read<CartProvider>().saveLater = true;
                                  widget.setState();
                                  context.read<CartProvider>().buyNow(
                                      update: widget.setState,
                                      fromSave: false,
                                      id: cartList[index]
                                                  .productList![0]
                                  ...
                                  () async {
                                    context.read<CartProvider>().saveLater =
                                        true;
                                    context
                                        .read<CartProvider>()
                                        .setProgress(true);
