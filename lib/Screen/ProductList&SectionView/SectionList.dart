...
import 'package:eshop_multivendor/Screen/Product_Detail/Widget/commanFiledsofProduct.dart';
...
class StateSection extends State<SectionList> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                    ...
                                    ? context
                                        ...
                                        ? NotificationListener<
                                            ...
                                            child: ListView.builder(
                                              ...
                                              itemCount: (widget.section_model!
                                                          .offset! <
        ...
        bottomNavigationBar: widget.productList!.isNotEmpty
            ? Container(
              ...
              children: [
                InkWell(
                  onTap: () {
                    ...
                    } else if (widget.productList!.isNotEmpty &&
                ...
                GestureDetector(
                  onTap: () {
                    if (widget.section_model!.filterList!.isNotEmpty) {
                      filterDialog();
                    } else {
