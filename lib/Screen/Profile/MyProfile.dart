  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        context.read<UserProvider>().userId == ''
            ? const SizedBox()
            : _getDrawerItem(getTranslated(context, 'MYTRANSACTION'), 'pro_th'),
        _getDrawerItem(getTranslated(context, 'CHANGE_THEME_LBL'), 'pro_theme'),
        _getDrawerItem(
        ...
        _getDrawerItem(getTranslated(context, 'CONTACT_LBL'), 'pro_contact_us'),
      ...
      child: ListTile(
        ...
        onTap: () {
          if (title == getTranslated(context, 'MY_ORDERS_LBL')) {
            ...
            var str =
                "$appName\n\n${getTranslated(context, 'APPFIND')}${context.read<AppSettingsCubit>().getandroidLink()!}\n\n ${getTranslated(context, 'IOSLBL')}\n${context.read<AppSettingsCubit>().getiosLink()!}";
            Share.share(str,
