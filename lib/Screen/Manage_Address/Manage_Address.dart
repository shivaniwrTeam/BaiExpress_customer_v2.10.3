        ...
        RadioModel(
          ...
          onSetDefault: () {
            if (context.read<CartProvider>().addressList[i].isDefault != '1') {
              ...
              setSnackbar(
                  getTranslated(context, 'Already_set_as_default'), context);
            }
          },
          onDeleteSelected: () {
            showDialog(
                  ...
                  actions: <Widget>[
                    ...
                    TextButton(
                      child: Text(
                        ...
                        style: TextStyle(
                            color: Colors
                                .red), // Set delete text to red for emphasis
                      ),
                      onPressed: () {
                        if (mounted) {
                          setState(
                            () {
                              context.read<ManageAddrProvider>().changeStatus(
                                  ManageAddrProviderStatus.inProgress);
                        ...
                        Future.delayed(Duration.zero)
                          ...
                          (value) {
                            ...
                            if (context
                                ...
                                .addressList
                                .isEmpty) {
                              if (context.read<CartProvider>().deliveryCharge >
                                  0) {
