...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    var reviewImg = json[REV_IMG] == null ? [] : (json[REV_IMG] as List?);
    ...
    return Product(
        ...
        tax: json[TAX_PER],
        totalTax: json['total_tax_percentage'],
        total: json[TOTAL],
...
class Attribute {
  ...
  String getSType(int index) {
    return sType!.split(',')[index].trim();
  }

  String getSValue(int index) {
    return sValue!.split(',')[index].trim();
  }
  ...
  bool isImageType(int index) {
    return getSType(index) == '2';
  }

  bool isColorType(int index) {
    return getSType(index) == '1';
  }

  Color getColorValue(int index) {
    return Color(int.parse('0xff${getSValue(index).substring(1)}'));
  }
...
class AttributeSelection {
  Attribute oneAttributeList;
  String selectedId;
  AttributeSelection(
      {required this.oneAttributeList, required this.selectedId});
}
