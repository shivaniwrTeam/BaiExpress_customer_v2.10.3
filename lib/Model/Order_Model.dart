...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return OrderModel(
      ...
      attachments: parsedJson['order_prescription_attachments'] == null
          ? []
          : List<String>.from(
              parsedJson['order_prescription_attachments']!.map((x) => x)),
    );
  }
}
